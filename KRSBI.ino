...
int RPWM = 4;  // Digital/PWM pin 5 to the RPWM on the BTS7960
int LPWM = 5;  // Digital/PWM pin 6 to the LPWM on the BTS7960

// Enable "Left" and "Right" movement
int L_EN = 20;  // connect Digital/PWM pin 7 to L_EN on the BTS7960
int R_EN = 21;  // connect Digital/PWM pin 8 to R_EN on the BTS7960
